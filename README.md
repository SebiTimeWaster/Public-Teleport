...
- Download the `.jar` file from the [Releases page](https://github.com/SebiTimeWaster/Public-Teleport/releases) page that fits your Minecraft version into your `mods` folder on your server or client
- Edit the configuration as described in [Configuration](#configuration) if needed
